...
export const SortAscIcon: React.FC<IconProps> = (props) => ( // Using an Arrow Up icon, can be rotated for desc
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <line x1="12" y1="19" x2="12" y2="5"></line>
        <polyline points="5 12 12 5 17 12"></polyline>
    </svg>
);
...
export const FireIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-2.072-2.143-3-3a6.5 6.5 0 1 0 12 6 2.5 2.5 0 0 1-1 2C15.5 15.5 6 16.5 6 16.5"></path>
        <path d="M12 2l-1 2c-1.5 3-4.5 6-4.5 9a5.5 5.5 0 1 0 11 0c0-3-3-6-4.5-9L12 2z"></path>
    </svg>
);
